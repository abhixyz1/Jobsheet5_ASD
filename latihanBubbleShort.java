 ...
 * @author Abhinaya
 */
public class latihanBubbleShort {
    public static void main(String[] args) {

        /*
         * Materi : Bubble Short
         * Bubble Short adalah metode algoritma pengurutan sederhana yang bekerja dengan cara bergerak berulang dari awal hingga akhir data untuk
         ...
         * 
         * ilustrasi cara kerja bubble short :
         * Awal : 7, 1, 3, 4, 9, 2, 6
         * - Iterasi 1 :
        ...
        // Implementasi Bubble Short dengan Java
        ...
        System.out.println("Array Sebelum Bubble Short");
        for (int i = 0; i < n; i++) {
